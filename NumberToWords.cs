...
namespace SharedClasses
{
    public class NumberToWords
    {
            ...
            public CurrencyInfo(Currencies currency)
            {
                switch (currency)
                {
                    ...
                    case Currencies.CFA:
                        ...
                        CurrencyCode = "CFA";
                        IsCurrencyNameFeminine = true;
                        EnglishCurrencyName = "CFA";
                        EnglishPluralCurrencyName = "CFA";
                        EnglishCurrencyPartName = "Centime";
                        EnglishPluralCurrencyPartName = "Centimes";
                        Arabic1CurrencyName = "فرنك إفريقي";
                        Arabic2CurrencyName = "فرنكين إفريقي";
                        Arabic310CurrencyName = "فرنك إفريقي";
                        Arabic1199CurrencyName = "فرنك إفريقي";
                        Arabic1CurrencyPartName = "سنت";
                        Arabic2CurrencyPartName = "سنتين";
                        Arabic310CurrencyPartName = "سنتات";
                        Arabic1199CurrencyPartName = "سنت";
                    ...
                    case Currencies.Euro:
                        ...
                        Arabic2CurrencyName = "إثنين يورو";
                        Arabic310CurrencyName = "يورو";
        ...
        public static string multiLingualNumberInText(decimal _amount, short? _currencyProfileId, short _languageId)
        {
        ...
        private readonly static string[] englishOnes =
            new string[] {
        "Zero", "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine",
        "Ten", "Eleven", "Twelve", "Thirteen", "Fourteen", "Fifteen", "Sixteen", "Seventeen", "Eighteen", "Nineteen"
        };

        private readonly static string[] englishTens =
            new string[] {
        "Twenty", "Thirty", "Forty", "Fifty", "Sixty", "Seventy", "Eighty", "Ninety"
        };

        private readonly static string[] englishGroup =
            new string[] {
        ...
        private readonly static string[] arabicOnes =
            new string[] {
        String.Empty, "واحد", "اثنان", "ثلاثة", "أربعة", "خمسة", "ستة", "سبعة", "ثمانية", "تسعة",
        "عشرة", "أحد عشر", "اثنا عشر", "ثلاثة عشر", "أربعة عشر", "خمسة عشر", "ستة عشر", "سبعة عشر", "ثمانية عشر", "تسعة عشر"
        };

        private readonly static string[] arabicFeminineOnes =
            new string[] {
